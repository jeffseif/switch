...
class WalmartSession(
    WebSession,
    namedtuple("WalmartSession", ["product_id", "product_description", "is_console"]),
):

    # Based upon https://gist.github.com/rms1000watt/c22cab5aed126824ac0c680fce6669aa

    AVAILABLE = "AVAILABLE"
    GET_URL_TEMPLATE = "https://www.walmart.com/terra-firma/item/{:s}/location/{:d}?selected=true&wl13="  # noqa: E501
    IN_STOCK = "IN_STOCK"
    WALMART_HEADERS = {
        "Authority": "www.walmart.com",
        "Referer": "https://www.walmart.com/ip/Nintendo-Switch-Gaming-Console-with-Gray-Joy-Con-N-A/55449983",  # noqa: E501
    }
    ...
    def run_session_for_zipcode(cls, zipcode, product_id):
        cls.info(
            "Performing API call for `{:s}` in {:d} ...".format(product_id, zipcode),
        )
        session = Session()
